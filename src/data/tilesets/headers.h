...
const struct Tileset gTileset_AutumRuins =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_AutumRuins,
    .palettes = gTilesetPalettes_AutumRuins,
    .metatiles = gMetatiles_AutumRuins,
    .metatileAttributes = gMetatileAttributes_AutumRuins,
    .callback = NULL,
};
